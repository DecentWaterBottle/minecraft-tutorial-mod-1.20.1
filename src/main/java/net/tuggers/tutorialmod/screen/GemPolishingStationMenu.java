package net.tuggers.tutorialmod.screen;
...
import net.tuggers.tutorialmod.block.entity.GemPolishingStationBlockEntity;
...
public class GemPolishingStationMenu extends AbstractContainerMenu {
    ...
    protected GemPolishingStationMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
